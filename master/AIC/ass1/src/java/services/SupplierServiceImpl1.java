...
@WebService(endpointInterface = "services.SupplierServiceImpl1",
serviceName = "SupplierService", portName="SupplierPT", targetNamespace="http://infosys.tuwien.ac.at/aic10/ass1/dto/supplier")
public class SupplierServiceImpl1 implements SupplierService {

    private String printPrefix = "[SupplierServiceImpl1]: ";
