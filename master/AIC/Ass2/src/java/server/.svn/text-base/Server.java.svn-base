...
import services.interfaces.registry.RegistryService;
...
public class Server {
	...
	public Server() throws Exception {
		...
		Endpoint.publish(ADDRESS + "customerwrapperservice", customer);
		...
		System.out.println("Generated Warehouse Products:");
		System.out.println("---------------------------------------------");
		for (StockStatus s : DataBackend.getInstance().getWarehouseList()) {
			System.out.println(s);
		}

                System.out.println("\nGenerated Supplier 2 Products:");
		System.out.println("---------------------------------------------");
