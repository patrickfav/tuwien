...
public class Client {
	...
	private static final QName WAREHOUSE_SERVICE_NAME = new QName("http://infosys.tuwien.ac.at/aic10/ass1/dto/warehouse","WarehouseService");
	private static final QName REGISTRY_SERVICE_NAME = new QName("http://infosys.tuwien.ac.at/aic10/ass1/dto/registry","RegistryService");
	private static final QName SUPPLIER_SERVICE_NAME = new QName("http://infosys.tuwien.ac.at/aic10/ass1/dto/supplier","SupplierService");
	private static final QName CUSTOMER_SERVICE_NAME = new QName("http://infosys.tuwien.ac.at/aic10/ass1/dto/customer","CustomerService");
	...
	public void executeWarehouseCheckAvailabilityTest() {
		System.out.println("=============================================");
	...
	public void executeWarehouseOrderTest() {
		System.out.println("=============================================");
	...
	public void executeSupplier1OrderTest() {
		System.out.println("=============================================");
	...
	public void executeSupplier2OrderTest() {
		System.out.println("=============================================");
	...
	public void executeRegistryTest() {
		System.out.println("=============================================");
	...
	public void executeShippingTest() throws UnknownAddressFault_Exception, UnknownProductFault_Exception {
		System.out.println("=============================================");
	...
	public void executeGetCustomerTest() throws Exception {
		...
		in = url.openStream();
		System.out.println("Stream should be empty: " + getStringFromInputStream(in));
	}
