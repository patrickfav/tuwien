...
public class ShippingService_Service extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("http://localhost:9000/shippingservice?wsdl");
        } catch (MalformedURLException e) {
            System.err.println("Can not initialize the default wsdl from http://localhost:9000/shippingservice?wsdl");
            // e.printStackTrace();
        }
        WSDL_LOCATION = url;
    }

    public ShippingService_Service(URL wsdlLocation) {
        super(wsdlLocation, SERVICE);
    }

    public ShippingService_Service(URL wsdlLocation, QName serviceName) {
        super(wsdlLocation, serviceName);
    }

    public ShippingService_Service() {
