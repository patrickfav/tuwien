...
webui.suntheme.body = function(viewId, path, defaultFocusElementId, 
	...
	*/
	...
	if (isElementNode) {
	    ...
	    //
	    webui.suntheme.common.body.updateFocusElementField(node);
	}
	return true;
    };
	...
	if (window.document.addEventListener) {
		...
		webui.suntheme.common.body.focusListener, true);
	} else {
	    document.attachEvent('onfocusin', 
		webui.suntheme.common.body.focusListener);
	}
        ...
        // setDefaultFocus
        //
	window.setTimeout('webui.suntheme.common.body.setDefaultFocus()',
	    10);
	...
	//
	webui.suntheme.common.body.setDefaultScrollPosition();
    };
	...
	webui.suntheme.common.body.storeScrollPosition();
    };
