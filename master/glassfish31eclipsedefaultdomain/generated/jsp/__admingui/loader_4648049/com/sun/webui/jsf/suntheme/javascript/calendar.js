...
webui.suntheme.calendar = {
    ...
    init: function(props) {
        ...
        domNode.monthMenu = webui.suntheme.listbox.getSelectElement(props.monthMenuId);
        domNode.yearMenu = webui.suntheme.listbox.getSelectElement(props.yearMenuId);

        // Set functions.
        domNode.toggle = webui.suntheme.calendar.toggleCalendar;
        domNode.dayClicked = webui.suntheme.calendar.dayClicked;
        domNode.decreaseMonth = webui.suntheme.calendar.decreaseMonth;
        domNode.increaseMonth = webui.suntheme.calendar.increaseMonth;
        domNode.redrawCalendar = webui.suntheme.calendar.redrawCalendar;
        domNode.setCurrentValue = webui.suntheme.calendar.setCurrentValue;
        domNode.setDisabled = webui.suntheme.calendar.setDisabled;
        domNode.setInitialFocus = webui.suntheme.calendar.setInitialFocus;
        domNode.formatDate = webui.suntheme.calendar.formatDate;
        domNode.ieStackingContextFix = webui.suntheme.calendar.ieStackingContextFix;
        domNode.ieGetShim = webui.suntheme.calendar.ieGetShim;
        domNode.ieShowShim = webui.suntheme.calendar.ieShowShim;
        domNode.ieHideShim = webui.suntheme.calendar.ieHideShim;
        domNode.setSelectedValue = webui.suntheme.calendar.setSelectedValue;
        domNode.setLimitedSelectedValue = webui.suntheme.calendar.setLimitedSelectedValue;
        domNode.redrawPopup = webui.suntheme.calendar.redrawPopup;
    },
    ...
    setDisabled: function(disabled) {
        webui.suntheme.field.setDisabled(this.field.id, disabled);
        ...
        if(disabled) {
            webui.suntheme.common.addStyleClass(this.pattern, this.hiddenClass);
        } else {
            webui.suntheme.common.stripStyleClass(this.pattern, this.hiddenClass);
        }
    },
