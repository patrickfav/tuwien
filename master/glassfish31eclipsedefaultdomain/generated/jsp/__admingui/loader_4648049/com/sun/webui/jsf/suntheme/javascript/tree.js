...
/** 
 * Define webui.suntheme.tree name space. 
 */ 
webui.suntheme.tree = {
    /**
	...
	// Set functions.
        ...
        domNode.badCookieChars = webui.suntheme.tree.badCookieChars;
        domNode.getValidCookieName = webui.suntheme.tree.getValidCookieName;
	...
	*/
    ...
    clearHighlight: function(node) {
        if (node) {
	    node.className = webui.suntheme.props.tree.treeRowClass;
        }
        return true;
    },
    ...
    highlight: function(node) {
        if (node) {
	    node.className = 
	    	webui.suntheme.props.tree.selectedTreeRowClass;
            return true;
        }
        return false;
    },
