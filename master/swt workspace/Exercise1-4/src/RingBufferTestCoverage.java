 ...
 * @matNum 0426099
 * @exercise Exercise 1-1: Coverage - no changes since it already had 100 %
 * 
 */

public class RingBufferTestCoverage extends TestCase{
	 ...
	 */
	@Test
	public void testShouldEnqueAndDequeAllItemsSuccessfullyForString() {
		...
		assertTrue(stringRingBuffer5.isEmpty());
	}
	 ...
	 */
	@Test
	public void testShouldEnqueAndDequeAllItemsSuccessfullyForInt() {
		...
		assertTrue(intRingBuffer3.isEmpty());
	}
	 ...
	 */
	@Test
	public void testCombinedEnqueAndDequeSuccessfullForString() {	
		stringRingBuffer5.enqueue("Item 1");
		stringRingBuffer5.enqueue("Item 2");
		stringRingBuffer5.enqueue("Item 3");
	 ...
	 */
	@Test
	public void testShouldThrowExceptionForOverflow() {
	 ...
	 */
	@Test
	public void testShouldThrowExceptionForOverflowWithZeroCapacity() {
		try {
	...
	@Test
	public void testShouldThrowExceptionForUnderflowForString() {
		try {
	...
	@Test
	public void testShouldThrowExceptionForUnderflowForInt() {
		try {
