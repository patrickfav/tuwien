 ...
 */
public class SpecialFSM implements FsmModel
{
  ...
  public boolean action9Guard() { return ((state == 4) || (state == 10) || (state == 12)); }
  public @Action void action9()
  {
    state = 10;
  }

  public boolean action10Guard() { return ((state == 10) || (state == 11) || (state == 12)); }
  ...
  public boolean action13Guard() { return ((state == 7) || (state == 14)); }
  ...
  public boolean action18Guard() { return ((state == 16) || (state == 17) || (state == 19) || (state == 21)); }
  public @Action void action18()
  {
    state = 19;
  }

  public boolean action19Guard() { return ((state == 19) || (state == 20) || (state == 21)); }
  public @Action void action19()
  {
    state = 20;
  }

  public boolean action20Guard() { return ((state == 18) || (state == 21)); }
